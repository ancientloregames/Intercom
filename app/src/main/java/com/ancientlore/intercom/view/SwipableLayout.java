...
public class SwipableLayout extends ViewGroup
{
	...
	public SwipableLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr)
	{
	...
	public SwipableLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes)
	{
