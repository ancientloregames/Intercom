...
public class CircleImageView extends AppCompatImageView
{
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mCircleBackgroundColor = a.getColor(R.styleable.CircleImageView_backgroundColor, DEFAULT_CIRCLE_BACKGROUND_COLOR);
	...
	protected void onDraw(Canvas canvas) {
		if (mDisableCircularTransformation || getDrawable() instanceof TextDrawable) {
			super.onDraw(canvas);
			return;
		}
