...
class EmailLoginFragment
	: AuthFragment<EmailLoginViewModel, EmailLoginUiBinding>() {
	...
	@Inject
	protected lateinit var viewModel: EmailLoginViewModel
	...
	override fun requestViewModel() = EmailLoginViewModel()
