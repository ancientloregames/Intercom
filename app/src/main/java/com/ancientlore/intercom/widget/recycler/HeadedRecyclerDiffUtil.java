...
/**
 * HeadedRecyclerDiffUtil is a utility class that can calculate the difference between two lists and output a
 * list of update operations that converts the first list into the second one.
 * Note: It is based on {@link androidx.recyclerview.widget.DiffUtil}
 * and intended to work with the {@link HeadedRecyclerAdapter}
 * <p>
 * It can be used to calculate updates for a RecyclerView Adapter. See
 * {@link androidx.recyclerview.widget.ListAdapter} and
 * {@link androidx.recyclerview.widget.AsyncListDiffer} which can compute diffs using
 ...
 * on a background thread, get the {@link HeadedRecyclerDiffUtil.DiffResult} then apply it on the RecyclerView on the main
 * thread.
 * <p>
 ...
 * 
 * Modified by Mykola Makhyboroda 2021
 */
public class HeadedRecyclerDiffUtil
{
	 ...
	 * {@link HeadedRecyclerDiffUtil#calculateDiff(Callback, boolean)} call.
	 * <p>
	 ...
	 * {@link androidx.recyclerview.widget.RecyclerView.Adapter} via {@link #dispatchUpdatesTo(HeadedRecyclerAdapter)}.
	 */
	public static class DiffResult {
		 ...
		 * <p>
		 * For example, if you have an {@link androidx.recyclerview.widget.RecyclerView.Adapter Adapter}
		 ...
		 * {@link androidx.recyclerview.widget.RecyclerView.AdapterDataObserver AdapterDataObserver}
		 ...
		 * @see HeadedRecyclerAdapter
		 */
		public void dispatchUpdatesTo(final HeadedRecyclerAdapter adapter) {
			dispatchUpdatesTo(new HeadedRecyclerUpdater(adapter));
		}
		 ...
		 * @see #dispatchUpdatesTo(HeadedRecyclerAdapter)
		 */
